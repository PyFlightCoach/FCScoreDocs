...
| track_y          | rf_y_track    | vector_direction |             | Continuous | ANY                          | LINE, HORIZONTAL  | ANY    |
| track_z          | rf_z_track    | vector_direction |             | Continuous | ANY                          | LINE, HORIZONTAL  | ANY    |
| yaw              | rf_z_attitude | vector_direction |             | Continuous | ANY                          | LINE, !HORIZONTAL | ANY    |

## LOOP

| name            | measure              | visibility       | selectors   | criteria   | last   | this                  | next          |
|:----------------|:---------------------|:-----------------|:------------|:-----------|:-------|:----------------------|:--------------|
| axial_attitude  | loop_axial_attitude  | vector_direction |             | Continuous | ANY    | LOOP, !HORIZONTAL     | ANY           |
| axial_track     | loop_axial_track     | vector_direction |             | Continuous | ANY    | LOOP, HORIZONTAL      | ANY           |
...
| radial_attitude | loop_radial_attitude | vector_direction | last        | Single     | ANY    | LOOP, !HORIZONTALEXIT | !LOOPSEQUENCE |
| radial_track    | loop_radial_track    | vector_direction | last        | Single     | ANY    | LOOP, HORIZONTALEXIT  | !LOOPSEQUENCE |
...
| roll_rate | roll_rate | roll_rate    |             | Deviation  | ANY    | ROLL   | ANY    |
